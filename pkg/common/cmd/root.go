...
import (
	...
	"github.com/1nterdigital/aka-im-discover/version"
...
func defaultCmdOpts() *CmdOpts {
	return &CmdOpts{
		loggerPrefixName: "im-discover-log",
	}
}
...
func (r *RootCmd) getFlag(cmd *cobra.Command) (dir string, idx int, err error) {
...
func (r *RootCmd) initializeLogger(cmdOpts *CmdOpts) (err error) {
...
func (r *RootCmd) persistentPreRun(cmd *cobra.Command, opts ...func(*CmdOpts)) (err error) {
...
func NewRootCmd(processName string, opts ...func(*CmdOpts)) *RootCmd {
	...
	cmd := cobra.Command{
		Use:  "Start IM discover application",
